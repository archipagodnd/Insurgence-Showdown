 ...
 */
 ...
 const Chat = new (_class = class {
	 ...
	 */
	 ...
	 __init3() {this.Friends = new (0, _friends.FriendsDatabase)()}
	 __init4() {this.PM = _friends.PM}

	 __init5() {this.multiLinePattern = new PatternTester()}
	 ...
	 *********************************************************/
	 ...
	 __init7() {this.crqHandlers = {}}
	 __init8() {this.handlers = Object.create(null)}
	/** The key is the name of the plugin. */
	 __init9() {this.plugins = {}}
	/** Will be empty except during hotpatch */
	__init10() {this.oldPlugins = {}}
	__init11() {this.roomSettings = []}

	/*********************************************************
	 * Load chat filters
	 *********************************************************/
	 __init12() {this.filters = []}
	...
	loginfilter(user, oldUser, usertype) {
	 ...
	 __init16() {this.punishmentfilters = []}
	...
	/** language id -> language name */
	 __init19() {this.languages = new Map()}
	/** language id -> (english string -> translated string) */
	 __init20() {this.translations = new Map()}
	...
	tr(language, strings = '', ...keys) {
	 ...
	 __init21() {this.MessageContext = MessageContext}
	 __init22() {this.CommandContext = exports.CommandContext = CommandContext}
	 __init23() {this.PageContext = exports.PageContext = PageContext}
	 __init24() {this.ErrorMessage = exports.ErrorMessage = ErrorMessage}
	 __init25() {this.Interruption = exports.Interruption = Interruption}
	/**
	 * Command parser
	 *
	 * Usage:
...

 {
	...
	maybeNotifyBlocked(blocked, targetUser, user) {
	 ...
	 __init27() {this.formatText = _chatformatter.formatText}
	 __init28() {this.linkRegex = _chatformatter.linkRegex}
	 __init29() {this.stripFormatting = _chatformatter.stripFormatting}

	 __init30() {this.filterWords = {}}
	 __init31() {this.monitors = {}}
