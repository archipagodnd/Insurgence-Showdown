 ...
 class Auth extends Map {
	...
	isStaff(userid) {
		if (this.has(userid)) {
			...
			return Auth.atLeast(rank, '*') || Auth.atLeast(rank, exports.SECTIONLEADER_SYMBOL) || Auth.atLeast(rank, '%');
		} else {
			return false;
		}
	}
	...
	static hasPermission(
		...
		if (
			_optionalChain([room, 'optionalAccess', _ => _.settings, 'access', _2 => _2.section]) &&
			...
			Users.globalAuth.atLeast(user, exports.SECTIONLEADER_SYMBOL) &&
