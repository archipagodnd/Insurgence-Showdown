"use strict";Object.defineProperty(exports, "__esModule", {value: true}); function _optionalChain(ops) { let lastAccessLHS = undefined; let value = ops[0]; let i = 1; while (i < ops.length) { const op = ops[i]; const fn = ops[i + 1]; i += 2; if ((op === 'optionalAccess' || op === 'optionalCall') && value == null) { return undefined; } if (op === 'access' || op === 'optionalAccess') { lastAccessLHS = value; value = fn(value); } else if (op === 'call' || op === 'optionalCall') { value = fn((...args) => value.call(lastAccessLHS, ...args)); lastAccessLHS = undefined; } } return value; }var _randomteams = require('./random-teams');
 ...
 */
 function changeSet(context, pokemon, newSet, changeAbility = false) {
	...
	const evs = {
		hp: _optionalChain([newSet, 'access', _ => _.evs, 'optionalAccess', _2 => _2.hp]) || 0,
		atk: _optionalChain([newSet, 'access', _3 => _3.evs, 'optionalAccess', _4 => _4.atk]) || 0,
		def: _optionalChain([newSet, 'access', _5 => _5.evs, 'optionalAccess', _6 => _6.def]) || 0,
		spa: _optionalChain([newSet, 'access', _7 => _7.evs, 'optionalAccess', _8 => _8.spa]) || 0,
		spd: _optionalChain([newSet, 'access', _9 => _9.evs, 'optionalAccess', _10 => _10.spd]) || 0,
		spe: _optionalChain([newSet, 'access', _11 => _11.evs, 'optionalAccess', _12 => _12.spe]) || 0,
	};
	const ivs = {
		hp: _optionalChain([newSet, 'access', _13 => _13.ivs, 'optionalAccess', _14 => _14.hp]) || 31,
		atk: _optionalChain([newSet, 'access', _15 => _15.ivs, 'optionalAccess', _16 => _16.atk]) || 31,
		def: _optionalChain([newSet, 'access', _17 => _17.ivs, 'optionalAccess', _18 => _18.def]) || 31,
		spa: _optionalChain([newSet, 'access', _19 => _19.ivs, 'optionalAccess', _20 => _20.spa]) || 31,
		spd: _optionalChain([newSet, 'access', _21 => _21.ivs, 'optionalAccess', _22 => _22.spd]) || 31,
		spe: _optionalChain([newSet, 'access', _23 => _23.ivs, 'optionalAccess', _24 => _24.spe]) || 31,
	};
	pokemon.set.evs = evs;
	pokemon.set.ivs = ivs;
	...
	if (changeAbility) pokemon.setAbility(newSet.ability );
	...
	*/
	...
	setthestage: {
		...
		onSwitchIn(pokemon) {
			...
			changeSet(this, pokemon, _randomteams.ssbSets[forme]);
	...
	bambookingdom: {
		...
		onModifyPriority(priority, pokemon, target, move) {
			if (_optionalChain([move, 'optionalAccess', _26 => _26.category]) !== 'Status') return -7;
		},
		gen: 8,
	},
	...
	stubbornness: {
		...
		onFoeAfterBoost(boost, target, source, effect) {
			...
			if (_optionalChain([effect, 'optionalAccess', _27 => _27.name]) === 'Stubbornness') return;
			if (success) {
	...
	lastminutelag: {
		...
		onModifyMove(move, pokemon, target) {
			if (_optionalChain([move, 'access', _28 => _28.self, 'optionalAccess', _29 => _29.volatileStatus]) === 'mustrecharge') {
	...
	hecatomb: {
		...
		onSourceAfterFaint(length, target, source, effect) {
			if (effect && effect.effectType === 'Move') {
				...
				this.add(`c|${_conditions.getName.call(void 0, 'PartMan')}|THE LIGHT! IT BURNS!`);
				changeSet(this, source, _randomteams.ssbSets['PartMan-Shiny']);
			}
		},
		gen: 8,
	},
	...
	plausibledeniability: {
		...
		onModifyPriority(priority, pokemon, target, move) {
			if (_optionalChain([move, 'optionalAccess', _30 => _30.category]) === 'Status') {
		...
		onStart(target) {
			...
			if (target.side.pokemonLeft <= 3) {
				if (target.species.name === 'Necrozma-Dusk-Mane' && target.side.pokemonLeft === 1 && target.m.flag2) {
					changeSet(this, target, _randomteams.ssbSets['Robb576-Ultra']);
				} else if (target.species.name === "Necrozma-Dawn-Wings" && target.m.flag1) {
					changeSet(this, target, _randomteams.ssbSets['Robb576-Dusk-Mane']);
					target.m.flag2 = true;
				}
			}
			target.m.flag1 = true;
	...
	shadydeal: {
		...
		onTryHit(target, source, move) {
			if (target !== source && _optionalChain([this, 'access', _31 => _31.effectState, 'access', _32 => _32.immunities, 'optionalAccess', _33 => _33.includes, 'call', _34 => _34(move.type)])) {
	...
	combattraining: {
		...
		onDamage(damage, target, source, effect) {
			...
			if (
				_optionalChain([effect, 'optionalAccess', _35 => _35.effectType]) === 'Move' &&
		...
		onEnd(pokemon) {
			if (pokemon.illusion) {
				...
				if (!pokemon.volatiles[this.toID(pokemon.name)]) {
					...
					if (_optionalChain([status, 'optionalAccess', _36 => _36.exists])) {
	...
	stakeout: {
		...
		onModifyAtk(atk, attacker, defender) {
			if (!_optionalChain([defender, 'optionalAccess', _37 => _37.activeTurns])) {
		...
		onModifySpA(atk, attacker, defender) {
			if (!_optionalChain([defender, 'optionalAccess', _38 => _38.activeTurns])) {
				this.debug('Stakeout boost');
				return this.chainModify(2);
			}
		},
