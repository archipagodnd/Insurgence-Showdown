"use strict";Object.defineProperty(exports, "__esModule", {value: true}); function _optionalChain(ops) { let lastAccessLHS = undefined; let value = ops[0]; let i = 1; while (i < ops.length) { const op = ops[i]; const fn = ops[i + 1]; i += 2; if ((op === 'optionalAccess' || op === 'optionalCall') && value == null) { return undefined; } if (op === 'access' || op === 'optionalAccess') { lastAccessLHS = value; value = fn(value); } else if (op === 'call' || op === 'optionalCall') { value = fn((...args) => value.call(lastAccessLHS, ...args)); lastAccessLHS = undefined; } } return value; } const Moves = {
	...
	beatup: {
		...
		basePowerCallback(pokemon, target, move) {
			if (!_optionalChain([move, 'access', _ => _.allies, 'optionalAccess', _2 => _2.length])) return null;
			return 10;
		},
	...
	curse: {
		...
		onModifyMove(move, source, target) {
			...
			} else if (_optionalChain([target, 'optionalAccess', _3 => _3.volatiles, 'access', _4 => _4['substitute']])) {
				delete move.volatileStatus;
				delete move.onHit;
			}
		},
	...
	gravity: {
		...
		condition: {
			...
			durationCallback(source, effect) {
				if (_optionalChain([source, 'optionalAccess', _5 => _5.hasAbility, 'call', _6 => _6('persistent')])) {
	...
	healblock: {
		...
		condition: {
			...
			durationCallback(target, source, effect) {
				if (_optionalChain([source, 'optionalAccess', _7 => _7.hasAbility, 'call', _8 => _8('persistent')])) {
					this.add('-activate', source, 'ability: Persistent', effect);
					return 7;
				}
				return 5;
	...
	mirrormove: {
		...
		onHit(pokemon) {
			...
			if (!_optionalChain([lastAttackedBy, 'optionalAccess', _11 => _11.source, 'access', _12 => _12.lastMove]) || !lastAttackedBy.move) {
				 return false;
			}
			const noMirror = [
