...
export const Formats: FormatList = [
	...
	},
	{
		...
		mod: 'gen8',
		ruleset: ['Standard NatDex', 'Ban Unbalanced Moves', 'Level 120'],
	},
	//	{
	...
	},
	{
		...
		mod: 'gen8',
		ruleset: ['Standard NatDex', 'Ban Unbalanced Moves', 'OHKO Clause', 'Evasion Moves Clause', 'Species Clause', 'Dynamax Clause', 'Sleep Clause Mod'],
		banlist: [
			'Alakazam-Mega', 'Arceus', 'Blastoise-Mega', 'Blaziken-Mega', 'Calyrex-Ice', 'Calyrex-Shadow', 'Cinderace', 'Darkrai', 'Darmanitan-Galar',
			'Deoxys-Attack', 'Deoxys-Base', 'Deoxys-Speed', 'Dialga', 'Dracovish', 'Dragapult', 'Eternatus', 'Genesect', 'Gengar-Mega', 'Giratina',
			'Giratina-Origin', 'Groudon', 'Ho-Oh', 'Kangaskhan-Mega', 'Kyogre', 'Kyurem-Black', 'Kyurem-White', 'Landorus-Base', 'Lucario-Mega',
	...
	},
	{
		...
		mod: 'gen8',
		ruleset: ['Standard NatDex', 'Ban Unbalanced Moves', 'Same Type Clause', 'Species Clause', 'OHKO Clause', 'Evasion Moves Clause', 'Dynamax Clause', 'Sleep Clause Mod'],
		banlist: [
