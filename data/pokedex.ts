export const Pokedex: {[speciesid: string]: SpeciesData} = {
	...
	mukdelta: {
		...
		formeOrder: ["Muk-Delta", "Muk-Delta-Water", "Muk-Delta-Grass", "Muk-Delta-Fire", "Muk-Delta-Dark", "Muk-Delta-Normal", "Muk-Delta-Psychic"],
	},
	shellder: {
		num: 90,
		name: "Shellder",
	...
	togepi: {
		...
		color: "White",
		evos: ["Togetic"],
		otherFormes: ["Togepi-Archipago"],
		formeOrder: ["Togepi", "Togepi-Archipago"],
		eggGroups: ["Undiscovered"],
		canHatch: true,
	},
	togepiarchipago: {
		num: 175,
		name: "Togepi-Archipago",
		types: ["Fairy"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 35, atk: 20, def: 65, spa: 40, spd: 65, spe: 20},
		abilities: {0: "Hustle", 1: "Serene Grace", H: "Super Luck"},
	...
	togetic: {
		...
		evoType: "levelFriendship",
		evos: ["Togekiss"],
		otherFormes: ["Togetic-Archipago"],
		formeOrder: ["Togetic", "Togetic-Archipago"],
		eggGroups: ["Flying", "Fairy"],
	},
	togeticarchipago: {
		num: 176,
		name: "Togetic-Archipago",
		types: ["Fairy", "Psychic"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 55, atk: 40, def: 85, spa: 80, spd: 105, spe: 40},
		abilities: {0: "Hustle", 1: "Serene Grace", H: "Super Luck"},
		...
		weightkg: 3.2,
		color: "White",
		prevo: "Togepi-Archipago",
		evoType: "levelFriendship",
		evos: ["Togekiss-Archipago"],
		eggGroups: ["Flying", "Fairy"],
	},
	natu: {
		num: 177,
	...
	wooper: {
		...
		evos: ["Quagsire"],
		eggGroups: ["Water 1", "Field"],
		otherFormes: ["Wooper-Delta", "Wooper-Paldea"],
	...
	togekiss: {
		...
		evoType: "useItem",
		evoItem: "Shiny Stone",
		otherFormes: ["Togekiss-Archipago"],
		formeOrder: ["Togekiss", "Togekiss-Archipago"],
		eggGroups: ["Flying", "Fairy"],
	},
	togekissarchipago: {
		num: 468,
	...
	venipede: {
		...
		evos: ["Whirlipede"],
		eggGroups: ["Bug"],
		otherFormes: ["Venipede-Delta","Venipede-Archipago"],
		formeOrder: ["Venipede", "Venipede-Delta","Venipede-Archipago"],
	},
	venipededelta: {
		gen: 6,
		num: 543,
	...
	venipedearchipago: {
		gen: 6,
		num: 543,
		name: "Venipede-Archipago",
		baseSpecies: "Venipede",
		forme: "Archipago",
		types: ["Ice", "Fire"],
		baseStats: {hp: 30, atk: 45, def: 59, spa: 30, spd: 39, spe: 57},
		abilities: {0: "Ice Scales", 1: "Steam Engine", H: "Flash Fire"},
		weightkg: 5.3,
		heightm: 1,
		color: "Blue",
		evos: ["Whirlipede-Archipago"],
		eggGroups: ["Undiscovered"],
	},
	whirlipede: {
		num: 544,
		...
		evos: ["Scolipede"],
		eggGroups: ["Bug"],
		otherFormes: ["Whirlipede-Delta","Whirlipede-Archipago"],
		formeOrder: ["Whirlipede", "Whirlipede-Delta","Whirlipede-Archipago"],
	},
	whirlipededelta: {
		gen: 6,
		num: 544,
	...
	whirlipedearchipago: {
		...
		heightm: 1,
		color: "Blue",
		prevo: "Venipede-Archipago",
		evoLevel: 22,
		evos: ["Scolipede-Archipago"],
		eggGroups: ["Undiscovered"],
	},	
	scolipede: {
		num: 545,
		...
		evoLevel: 30,
		eggGroups: ["Bug"],
		otherFormes: ["Scolipede-Delta","Scolipede-Archipago"],
		formeOrder: ["Scolipede", "Scolipede-Delta","Scolipede-Archipago"],
	},
	scolipededelta: {
		gen: 6,
		num: 545,
	...
	scolipedearchipago: {
		gen: 6,
		num: 545,
		name: "Scolipede-Archipago",
		baseSpecies: "Scolipede",
		forme: "Archipago",
		types: ["Ice", "Fire"],
		baseStats: {hp: 65, atk: 50, def: 70, spa: 120, spd: 60, spe: 160},
		abilities: {0: "Ice Scales", 1: "Steam Engine", H: "Flash Fire"},
		weightkg: 200.5,
		heightm: 1,
		color: "Blue",
		prevo: "Whirlipede-Archipago",
		evoLevel: 30,
		eggGroups: ["Undiscovered"],
	},
	cottonee: {
	...
	greninja: {
		...
		evoLevel: 36,
		eggGroups: ["Water 1"],
		otherFormes: ["Greninja-Bond", "Greninja-Delta", "Greninja-Ash"],
		formeOrder: ["Greninja", "Greninja-Bond", "Greninja-Delta", "Greninja-Ash"],
	},
	greninjabond: {
		num: 658,
		name: "Greninja-Bond",
	...
	hoopadelta: {
		...
		formeOrder: ["Hoopa-Delta", "Hoopa-Delta-Unleashed"],
	},
	hoopadeltaunleashed: {
		gen: 6,
		num: 720,
	...
	bushil: {
		...
		name: "Bushil",
		types: ["Grass", "Fairy"],
		baseStats: {hp: 40, atk: 65, def: 70, spa: 35, spd: 45, spe: 30},
		abilities: {0: "Harvest", 1: "Effect Spore", H: "Immunity"},
		heightm: 0.2,
		weightkg: 1.5,
		color: "Green",
		evos: ["Bushbun"],
	...
	bushbun: {
		...
		name: "Bushbun",
		types: ["Grass", "Fairy"],
		baseStats: {hp: 60, atk: 90, def: 120, spa: 45, spd: 80, spe: 50},
		abilities: {0: "Harvest", 1: "Effect Spore", H: "Immunity"},
		heightm: 1,
		weightkg: 11.5,
		color: "Green",
	...
	dracoloach: {
		...
		name: "Dracoloach",
		types: ["Water", "Dragon"],
		baseStats: {hp: 78, atk: 75, def: 70, spa: 95, spd: 95, spe: 95},
		abilities: {0: "Marvel Scale", 1: "Rain Dish", H: "Multiscale"},
		heightm: 5,
		weightkg: 110,
		color: "Blue",
		prevo: "Barboach",
	...
	cryometry: {
		...
		name: "Cryometry",
		types: ["Ice"],
		baseStats: {hp: 40, atk: 30, def: 30, spa: 63, spd: 100, spe: 70},
		abilities: {0: "Ice Scales", 1: "Levitate"},
		heightm: 0.3,
		weightkg: 0.4,
		color: "White",
		evos: ["Cryogonal"],
	...
	lapuddle: {
		...
		name: "Lapuddle",
		types: ["Water","Ice"],
		baseStats: {hp: 20, atk: 10, def: 55, spa: 15, spd: 55, spe: 80},
		abilities: {0: "Water Absorb", 1: "Shell Armor", H: "Hydration"},
		heightm: 0.3,
		weightkg: 0.4,
		color: "Blue",
	...
	whoopwing: {
		...
		name: "Whoopwing",
		types: ["Normal", "Flying"],
		baseStats: {hp: 45, atk: 52, def: 39, spa: 41, spd: 38, spe: 57},
	...
	miamacaw: {
		...
		name: "Miamacaw",
		types: ["Normal", "Flying"],
		baseStats: {hp: 70, atk: 90, def: 70, spa: 76, spd: 70, spe: 92},
		abilities: {0: "Big Pecks", 1: "Tangled Feet"},
		heightm: 0.9,
		weightkg: 19.9,
		color: "Red",
	...
	hollotite: {
		...
		name: "Hollotite",
		types: ["Rock"],
		baseStats: {hp: 50, atk: 70, def: 80, spa: 40, spd: 40, spe: 20},
	...
	stalacpace: {
		...
		name: "Stalacpace",
		types: ["Rock", "Dark"],
		baseStats: {hp: 60, atk: 100, def: 100, spa: 70, spd: 50, spe: 40},
		abilities: {0: "Rock Head", 1: "Shell Armor"},
		heightm: 1,
		weightkg: 112,
		color: "Brown",
	...
	stalagoliath: {
		...
		name: "Stalagoliath",
		types: ["Rock", "Dark"],
		baseStats: {hp: 70, atk: 120, def: 115, spa: 110, spd: 60, spe: 65},
	...
	dormie: {
		...
		name: "Dormie",
		types: ["Fairy", "Ground"],
		baseStats: {hp: 33, atk: 36, def: 66, spa: 70, spd: 50, spe: 37},
		abilities: {0: "Magic Bounce"},
		heightm: 0.4,
		weightkg: 2.4,
		color: "Brown",
	...
	dreamie: {
		...
		name: "Dreamie",
		types: ["Fairy", "Ground"],
		baseStats: {hp: 56, atk: 70, def: 92, spa: 107, spd: 70, spe: 75},
		abilities: {0: "Magic Bounce"},
		heightm: 0.9,
		weightkg: 5,
		color: "Brown",
	...
	florcoon: {
		...
		name: "Florcoon",
		types: ["Grass", "Normal"],
		baseStats: {hp: 45, atk: 55, def: 45, spa: 50, spd: 45, spe: 40},
		abilities: {0: "Overgrow", 1: "Scrappy"},
		heightm: 0.8,
		weightkg: 14,
		color: "Brown",
		evos: ["Bufaroon"],
	...
	bufaroon: {
		...
		name: "Bufaroon",
		types: ["Grass", "Normal"],
		baseStats: {hp: 65, atk: 75, def: 60, spa: 75, spd: 65, spe: 60},
		abilities: {0: "Overgrow", 1: "Scrappy"},
		heightm: 1,
		weightkg: 50,
		color: "Brown",
	...
	grandaroon: {
		...
		name: "Grandaroon",
		types: ["Grass", "Normal"],
		baseStats: {hp: 105, atk: 100, def: 95, spa: 80, spd: 95, spe: 60},
		abilities: {0: "Overgrow", 1: "Scrappy"},
		heightm: 2,
		weightkg: 200,
		color: "Brown",
	...
	matriwi: {
		...
		name: "Matriwi",
		types: ["Normal"],
		baseStats: {hp: 65, atk: 75, def: 62, spa: 75, spd: 62, spe: 96},
		abilities: {0: "Parental Bond"},
		heightm: 0.7,
		weightkg: 12,
		color: "Brown",
	...
	pawdingus: {
		...
		name: "Pawdingus",
		types: ["Fairy","Normal"],
		baseStats: {hp: 45, atk: 45, def: 55, spa: 5, spd: 45, spe: 30},
		abilities: {0: "Fluffy", 1: "Klutz", H: "Cute Charm"},
		heightm: 0.2,
		weightkg: 1,
		color: "Green",
	...
	linkite: {
		...
		name: "Linkite",
		types: ["Ghost","Normal"],
		baseStats: {hp: 35, atk: 45, def: 25, spa: 45, spd: 50, spe: 30},
		abilities: {0: "Shadow Tag", 1: "Cursed Body", H: "Cute Charm"},
		heightm: 0.6,
		weightkg: 10,
		color: "Green",
		prevo: "Pawdingus",
	...
	crocodily: {
		...
		name: "Crocodily",
		types: ["Grass","Water"],
		baseStats: {hp: 45, atk: 71, def: 38, spa: 54, spd: 38, spe: 53},
		abilities: {0: "Swift Swim", 1: "Leaf Guard", H: "Strong Jaw"},
		heightm: 0.5,
		weightkg: 10,
		color: "Green",
		evos: ["Logrodile"],
	...
	logrodile: {
		...
		name: "Logrodile",
		types: ["Grass","Water"],
		baseStats: {hp: 65, atk: 87, def: 58, spa: 79, spd: 58, spe: 73},
		abilities: {0: "Swift Swim", 1: "Analytic", H: "Strong Jaw"},
		heightm: 0.9,
		weightkg: 30,
		color: "Green",
		prevo: "Crocodily",
	...
	jawligator: {
		...
		name: "Jawligator",
		types: ["Grass","Water"],
		baseStats: {hp: 81, atk: 103, def: 80, spa: 86, spd: 72, spe: 73},
		abilities: {0: "Swift Swim", 1: "Analytic", H: "Strong Jaw"},
		heightm: 1.9,
		weightkg: 150,
		color: "Green",
	...
	tadit: {
		...
		name: "Tadit",
		types: ["Water","Normal"],
		baseStats: {hp: 40, atk: 45, def: 40, spa: 45, spd: 40, spe: 70},
		abilities: {0: "Swift Swim"},
		heightm: 0.6,
		weightkg: 10,
		color: "Green",
	...
	ribhit: {
		...
		name: "Ribhit",
		types: ["Water","Normal"],
		baseStats: {hp: 96, atk: 65, def: 65, spa: 65, spd: 65, spe: 55},
		abilities: {0: "Parental Bond"},
		heightm: 1.2,
		weightkg: 30,
		color: "Green",
