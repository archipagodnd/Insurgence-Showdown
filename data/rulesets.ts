...
export const Rulesets: {[k: string]: FormatData} = {
	...
	standard: {
		...
		ruleset: [
			'Obtainable', 'Team Preview', 'Sleep Clause Mod', 'Nickname Clause', 'OHKO Clause', 'Evasion Items Clause',
			'Evasion Moves Clause', 'Endless Battle Clause', 'HP Percentage Mod', 'Cancel Mod', 'Overflow Stat Mod',
		],
	...
	standarddoubles: {
		...
		ruleset: [
			...
			'Min Source Gen = 9', 'Overflow Stat Mod'
		],
	},
	standardnatdexdoubles: {
		...
		ruleset: [
			...
			'Evasion Moves Clause', 'Gravity Sleep Clause', 'Endless Battle Clause', 'Overflow Stat Mod',
	...
	standardoms: {
		...
		ruleset: [
			'Standard NatDex', 'Dynamax Clause', 'Overflow Stat Mod',
		],
	},
	banunbalancedmoves: {
		effectType: 'ValidatorRule',
	...
	standardnatdex: {
		...
		ruleset: [
			'Obtainable', '+Unobtainable', '+Past', 'Sketch Post-gen 7 Moves', '+PastMove', 'Team Preview', 'Nickname Clause', 'HP Percentage Mod', 'Cancel Mod', 'Endless Battle Clause', 'Overflow Stat Mod',
		],
		onValidateSet(set) {
			const species = this.dex.species.get(set.species);
	...
	draft: {
		...
		ruleset: [
			...
			'Adjust Level = 120', 'Max Level = 120', 'Default Level = 120', 'Overflow Stat Mod',
		],
		onDamagingHit(damage, target, source, move) {
			if (target.illusion) {
				this.debug('illusion cleared');
		...
		onTeamPreview() {
			...
			for (const pokemon of this.getAllPokemon()) {
				const details = pokemon.details.replace(', shiny', '')
					.replace(/(Greninja|Gourgeist|Pumpkaboo|Xerneas|Silvally|Urshifu|Muk-Delta|Dudunsparce)(-[a-zA-Z?-]+)?/g, '$1-*')
